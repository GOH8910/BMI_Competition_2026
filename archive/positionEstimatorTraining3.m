function modelParameters = positionEstimatorTraining3(training_data)
    ...
    % Precompute per-trial PC projections and displacement trajectories
    ...
    for k = 1:nDirections
        ...
        % Average displacement trajectory for direction k
        avg = zeros(2, maxLen);
        cnt = zeros(1, maxLen);
        for n = 1:nTrials
            dxy = trajDisp{k}{n};
